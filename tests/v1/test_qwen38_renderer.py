...
async def test_qwen38_pool_defaults_to_prime_xhigh_and_preserved_thinking():
    pool = ElasticRendererPool(_tokenizer_snapshot(), None, multiplex=1)
...
async def test_qwen38_pool_applies_config_and_reasoning_effort():
